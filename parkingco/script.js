...
document.getElementById('btn-reservar').addEventListener('click', function() {
  ...
  if (!fechaEntrada || !horaEntrada || !fechaSalida || !horaSalida || !tipoVehiculo) {
    feedback.style.display = 'block';
    feedback.style.color = '#c0392b';
  ...
  feedback.style.display = 'block';
  feedback.style.color = 'green';
  feedback.textContent = '¡Reserva realizada con éxito! Te enviaremos un correo de confirmación.';
